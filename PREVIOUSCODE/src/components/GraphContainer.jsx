...
class GraphContainer extends Component{
  clickGraph = () =>{
    ...
    this.props.toggleFixHover(true);
    this.props.toggleHoverModal(true);
  }
...
// if problem data addition
  ...
  constructor(props){
    ...
    this.state = {
      focusedNodeId:"",
      data:{
        nodes:[{id:"test",color:"black",symbolType:"diamond"}],
        links:[],
      },
      config: {
...
// Focus starter placeholder node for zoom animation
  componentDidMount(){
    console.log("START LOG MOUNT PROPS");
    console.log(this.props);
    console.log("END LOG MOUNT PROPS");
...
// If we didn't double click the node, hide NodeExt
  onMouseOutNode = id =>{
    ...
    this.props.toggleHoverModal(this.props.hoverVisible);
  }
...
GraphContainer.PropTypes = {
  ...
  hoverFix: PropTypes.bool.isRequired,
  toggleFixHover: PropTypes.func.isRequired,
