...
function annotationReferencesId(annotation, name) {
  ...
  try {
    for (var _iterator = (0, _typeAnnotationIterator.default)(annotation)[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
