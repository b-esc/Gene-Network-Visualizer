...
function getPathComments(path) {
  ...
  if (path.node.comments) {
    ...
    try {
      for (var _iterator2 = path.node.comments[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  if (path.node.leadingComments) {
    ...
    try {
      for (var _iterator3 = path.node.leadingComments[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
  ...
  if (path.node.innerComments) {
    ...
    try {
      for (var _iterator4 = path.node.innerComments[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
        var _comment2 = _step4.value;
