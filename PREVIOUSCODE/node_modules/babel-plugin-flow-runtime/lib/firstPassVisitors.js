...
function firstPassVisitors(context) {
  return {
    ...
    VariableDeclarator: function VariableDeclarator(path) {
      ...
      try {
        for (var _iterator2 = (0, _findIdentifiers.default)(path.get('id'))[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var id = _step2.value;
    ...
    Function: function Function(path) {
      ...
      if (path.has('returnType') || params.length || typeParameters.length) {
        ...
        try {
          for (var _iterator3 = (0, _findIdentifiers.default)(params)[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
            var id = _step3.value;
